	...
	function initFn(){
		//定义 form表单查询 信息
		 var formStructure={
	        ...
	        ,{display : ' 操作人姓名', code : 'userName', width : 200,  type:'text'}
		...
		var tableStructure = {
			...
			,{display : ' 插入时间 ', code : 'logTime', width : 130, align : 'left', type:'date', format:'yyyy-MM-dd HH:mm:ss', isOrder : false}
			//,{display : ' 日志类型 ', code : 'logType', width : 100, align : 'left', type:'text', isOrder : false}
			,{display : ' 所属模块 ', code : 'logModule', width : 180, align : 'left', type:'text', isOrder : false}
			,{display : ' 操作类型 ', code : 'logOperate', width : 130, align : 'left', type:'text', isOrder : false}
