...
//    private String stringPermissionsKeyPrefix = "string-permissions-";
    ...
    @Pointcut(value = "target(com.jy.modules.platform.sysauth.service.SysAclService)")
    ...
    @Pointcut(value = "target(com.jy.modules.platform.sysauth.service.SysRoleService)")
    ...
    @Pointcut(value = "target(com.jy.modules.platform.sysauth.service.SysRoleUserService)")
