...
public class CasAuthRealm extends CasRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(
		 ...
		 CasToken casToken = (CasToken) token;
	        ...
	        log.debug("AuthenticationInfo doGetAuthenticationInfo ticket:"+ticket);
	        ...
	        try {
	    		...
	    		UserInfo user = orgAPI.getUserInfoByLoginName(userId);
	    		if(user.getUserId() == null 
	    			...
	    			String msg = " doGetAuthenticationInfo obtaion userinfo is null userid:"+ userId;
	    			log.error(msg);
