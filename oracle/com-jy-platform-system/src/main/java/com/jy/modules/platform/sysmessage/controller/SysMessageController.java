...
import com.jy.modules.platform.sysmessage.dto.MessageStatus;
...
import com.jy.modules.platform.sysmessage.impl.MsgApiGetImpl;
import com.jy.modules.platform.sysmessage.impl.MsgApiUpdateImpl;
...
import com.jy.platform.core.common.SystemFlag;
...
public class SysMessageController extends BaseController{
    	...
    	try {
	    	...
	    	for(SysMessageDTO msg:list){
	            ...
	            String jyptAppId = "jypt"; // rest服务appId
	      	 	String jyptURL = RestService.getServiceUrl(jyptAppId);// rest服务地址
    ...
    private String queryUserAppCode() throws AbaboonException {
        ...
        try{
            ...
            ClassPathResource cp = new ClassPathResource("CAS_SSO.properties");
            properties.load(cp.getInputStream());
            appCode = properties.getProperty("app.code").trim(); 
        } catch(IOException e) {
            logger.debug("load CAS_SSO.properties error, default value , appCode=S000");
            return appCode;
            //throw new RuntimeException("load CAS_SSO.properties error!");
        }
        return appCode;
