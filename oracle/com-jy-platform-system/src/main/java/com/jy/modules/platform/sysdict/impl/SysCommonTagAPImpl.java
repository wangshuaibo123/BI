...
import com.jy.modules.platform.sysdict.service.SysCommonTagService;
import com.jy.platform.api.sysdict.SysCommonTagAPI;
/**
 * @description: 定义通用标签接口实现类
 * @author chen_gang
 * @date: 2016年2月14日 下午2:17:41
 */
@Component("com.jy.modules.platform.sysdict.impl.SysCommonTagAPImpl")
public class SysCommonTagAPImpl implements SysCommonTagAPI {
	...
	@Autowired
	@Qualifier("com.jy.modules.platform.sysdict.service.SysCommonTagService")
