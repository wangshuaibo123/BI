...
<!-- 列表按钮操作 start -->
    <div id="tableToolbar" class="tableToolbar" style="display:none;">
          <shiro:hasPermission name="platform/ruledefinition/queryRuleDefinition:add">
            ...
            <a href="javascript:void(0)" onclick="toAddData('${parentId}')" index="0">新增</a>
    ...
    function initFn(){
        //定义 form表单查询 信息
         var formStructure={
            // 定义form表单 字段信息
            columns : [
             {display : ' 规则集编码 ', code : 'ruleCode', width : 200,  type:'text'}
            ,{display : ' 规则名称 ', code : 'ruleName', width : 200,  type:'text'}
            ,{display : ' 父节点 ', code : 'parentId', width : 200,  type:'hidden', value:'${parentId}'}
        ...
        var tableStructure = {
            //定义table 列表的表头信息
            columns : [
             {display : ' 规则集编码 ', code : 'ruleCode', width : 200, align : 'left', type:'fun', isOrder : false,
              value:function (obj){
