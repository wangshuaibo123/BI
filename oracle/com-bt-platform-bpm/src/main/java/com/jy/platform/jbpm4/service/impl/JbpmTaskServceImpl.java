...
import com.jy.platform.jbpm4.tool.ParseXmlTool;
/**
 * 
 ...
 * @version V1.0
 */
@Service("com.jy.platform.jbpm4.service.impl.JbpmTaskServceImpl")
...
public class JbpmTaskServceImpl implements JbpmTastService,Serializable {
	...
	/*
	 * (non-Javadoc)
	 * @see com.jy.platform.jbpm4.service.JbpmTastService#batchUpdateAssignee(java.util.List, java.lang.String, java.lang.String)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.jy.platform.jbpm4.service.JbpmTastService#updateAssignee(java.lang.String, java.lang.String, java.lang.String, java.lang.String)
	 */
	@Transactional(rollbackFor=Exception.class)
...
/*
 * (non-Javadoc)
 * @see com.jy.platform.jbpm4.service.JbpmTastService#getUpTaskDealPersonInfo(java.util.Map)
 */
...
/*
 * (non-Javadoc)
 * @see com.jy.platform.jbpm4.service.JbpmTastService#obtainBizTabInfo(java.lang.String)
 */
...
/*
 * (non-Javadoc)
 * @see com.jy.platform.jbpm4.service.JbpmTastService#obtainJbpm4FormInfo(java.lang.String, java.lang.String, java.lang.String)
 */
...
/*
 * (non-Javadoc)
 * @see com.jy.platform.jbpm4.service.JbpmTastService#getFirstTaskByBizTabId(java.lang.String)
 */
...
/*
 * 	(non-Javadoc)
 * @see com.jy.platform.jbpm4.service.JbpmTastService#getTaskCunOfPseron(java.lang.String)
 */
	...
	public List<String> getTaskInfByUserId(String userId) {
		...
		if(dataList != null && dataList.size() >0){
			for(Map tem: dataList){
				String taskId = String.valueOf((BigDecimal)tem.get("TASKID"));
...
/*
 * (non-Javadoc)
 * @see com.jy.platform.jbpm4.service.JbpmTastService#getPartnerId(java.lang.String, java.util.Map)
 */
	...
	public String getPartnerId(String taskId, String turnDic,Map<String, Object> proMap){
		...
		if(formMap != null){
			...
			//否则继续
			//判断是否是会签
			if(StringUtil.isNotEmpty(turnDic) && turnDic.indexOf("会签")>0){
				//值为1是会签 
	...
	/*
	 * (non-Javadoc)
	 * @see com.jy.platform.jbpm4.service.JbpmTastService#obtainPartnerRuleOfNextTast(java.lang.String, java.lang.String, java.util.Map)
	 */
	public Map<String, Object> obtainPartnerRuleOfNextTast(String taskId,String turnDir, Map<String, Object> proMap) throws Exception {
		...
		try {
			String id=formService.queryJbpm4FormInfoIdBysql(processDefinition.getKey(), Integer.toString(processDefinition.getVersion()), proAcitityName);
			Jbpm4FormInfoDTO dto = new Jbpm4FormInfoDTO();
			dto.setId(Long.parseLong(id));
			Map<String, Object> paramMap = new HashMap<String, Object>();
			paramMap.put("dto", dto);
			Jbpm4FormInfoDTO modifyDto = formService.queryOneJbpm4FormInfo(paramMap);
			if((ConstantJBPM.JUMP_OUT_NAME.equals(turnDir)&&ConstantJBPM.JUMP_STATE_TRUE.equals(proMap.get("isJump")))||
					ConstantJBPM.BACK_OUT_NAME.equals(turnDir)&&ConstantJBPM.BACK_STATE_TRUE.equals(proMap.get("isBack"))){
				actName=(String) proMap.get(ConstantJBPM.JUMP_NAME_KEY);
			}
			
			if(ConstantJBPM.BACK_OUT_NAME.equals(turnDir)&&(ConstantJBPM.SHOW_BACK.equals(modifyDto.getExt3())||ConstantJBPM.SHOW_ALL.equals(modifyDto.getExt3()))){
				actName=(String) proMap.get(ConstantJBPM.JUMP_NAME_KEY);
			...
			logger.error("====obtainPartnerRuleOfNextTast error",e.getMessage(),e);
		}
	...
	private Map<String,Object> getTaskActivityName(String deploymentId,String resourceName,String turnDir,String actName,Map<String,Object> proMap,ProcessDefinition processDefinition) throws Exception{
		...
		try {
			...
			/*String id=formService.queryJbpm4FormInfoIdBysql(processDefinition.getKey(), Integer.toString(processDefinition.getVersion()), actName);*/
			Jbpm4FormInfoDTO dto = new Jbpm4FormInfoDTO();
			/*dto.setId(Long.parseLong(id));*/
			
			paramMap.put("dto", dto);
			
			paramMap.put("proDefKey", processDefinition.getKey());
			paramMap.put("proActivityName", actName);
			paramMap.put("proLevel", Integer.toString(processDefinition.getVersion()));
			Jbpm4FormInfoDTO modifyDto = formService.queryOneJbpm4FormInfo(paramMap);
			
			if(ConstantJBPM.JUMP_OUT_NAME.equals(turnDir)&&ConstantJBPM.JUMP_STATE_TRUE.equals(proMap.get("isJump"))||
					ConstantJBPM.BACK_OUT_NAME.equals(turnDir)&&ConstantJBPM.BACK_STATE_TRUE.equals(proMap.get("isBack"))){
				actName=(String) proMap.get("jumpName");
				return activityMap;
			}
			...
			logger.error("==========getTaskActivityName error",e.getMessage(),e);
			//logger.error("==========getTaskActivityName error",e.getMessage());
		}
	...
	private Map<String,Object> getTaskActivityOfDecision(String deploymentId,String resourceName,String actName,Map<String,Object> proMap,ProcessDefinition processDefinition) throws Exception{
		...
		for (int i=0; i< decisionElements.size(); i++) {
			...
			if(actName.equals(name)){
				...
				List<Element> handlerElements = ParseXmlTool.elementsMethod(decisionElement, "handler");//<handler class='com.jy.modules.befloan.jbpm.decision.CheckAuditAmountDec'/> 
	...
	/*
	 * (non-Javadoc)
	 * @see com.jy.platform.jbpm4.service.JbpmTastService#getTaskIdByProInsId(java.lang.String)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.jy.platform.jbpm4.service.JbpmTastService#exceptionStoProIns(java.lang.String, java.lang.String)
	 */
	@Transactional(rollbackFor=Exception.class)
    ...
    /*
     * (non-Javadoc)
     * @see com.jy.platform.jbpm4.service.JbpmTastService#updateJbpm4BizTabTaskEmergentState(java.lang.String, java.lang.String)
     */
    @Transactional(rollbackFor=Exception.class)
