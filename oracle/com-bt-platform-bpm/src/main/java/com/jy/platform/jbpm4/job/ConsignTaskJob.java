package com.jy.platform.jbpm4.job;
 ...
 */
@Component("com.jy.platform.jbpm4.job.ConsignTaskJob")
public class ConsignTaskJob implements Serializable,Job{
	...
	public void execute(JobExecutionContext context) throws JobExecutionException {
		...
		try {
			...
			consignService = (ConsignService) appCtx.getBean("com.jy.platform.jbpm4.service.impl.ConsignServiceImpl");
			jbpmService = (JbpmTastService) appCtx.getBean("com.jy.platform.jbpm4.service.impl.JbpmTaskServceImpl");
			...
			logger.error("==========com.jy.platform.jbpm4.job.ConsignTaskJob 执行失败===========",ex);
		}finally{
			isNext= true;
		}
