...
import com.jy.platform.jbpm4.service.JYTastService;
import com.jy.platform.jbpm4.service.Jbpm4BizOptionInfoService;
 ...
 */
@Service("com.jy.platform.jbpm4.service.impl.JYTastServiceImpl")
public class JYTastServiceImpl implements JYTastService,Serializable {
	private static final long serialVersionUID = 1L;
	private static final Logger logger = LoggerFactory.getLogger(JYTastServiceImpl.class);
	...
	@Autowired
	@Qualifier("com.jy.platform.jbpm4.service.Jbpm4BizOptionInfoService")
	...
	/*
	 * (non-Javadoc)
	 * @see com.jy.platform.jbpm4.service.JYTastService#startProIns(java.lang.String, java.util.Map, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.jy.platform.jbpm4.service.JYTastService#startProIns(java.lang.String, java.util.Map, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.jy.platform.jbpm4.service.JYTastService#autoCompleteFirstTask(java.lang.String, java.lang.String, java.util.Map)
	 */
	@Transactional(propagation=Propagation.REQUIRED,rollbackFor= Exception.class)
	...
	/*
	 * (non-Javadoc)
	 * @see com.jy.platform.jbpm4.service.JYTastService#completeTask(java.lang.String, java.lang.String, java.util.Map)
	 */
	@Transactional(propagation=Propagation.REQUIRED,rollbackFor= Exception.class)
	public void completeTask(String taskId, String turnDir,Map<String, Object> variables) throws Exception {
		...
		if(StringUtils.isNotEmpty(turnDir)){
			...
			String proProcessInsId = (String) variables.get("proProcessInsId");
			if(proProcessInsId != null && StringUtils.isNotEmpty(proProcessInsId) && !"null".equalsIgnoreCase(proProcessInsId)){
				String prodDefId=myJBPMTool.getHistoryService().createHistoryProcessInstanceQuery().processInstanceId(proProcessInsId).uniqueResult().getProcessDefinitionId();
				...
				String id=formService.queryJbpm4FormInfoIdBysql(processDefinition.getKey(), Integer.toString(processDefinition.getVersion()), (String) variables.get("proAcitityName"));
		    	...
		    	if(ConstantJBPM.JUMP_OUT_NAME.equals(turnDir)&&ConstantJBPM.JUMP_STATE_TRUE.equals(variables.get("isJump"))){
					this.completeJumpTask(taskId, turnDir, (String)variables.get(ConstantJBPM.JUMP_NAME_KEY), variables);
				}else if(ConstantJBPM.BACK_OUT_NAME.equals(turnDir)&&ConstantJBPM.BACK_STATE_TRUE.equals(variables.get("isBack"))){
					this.completeJumpTask(taskId, turnDir, (String)variables.get(ConstantJBPM.JUMP_NAME_KEY), variables);
				}else if(ConstantJBPM.BACK_OUT_NAME.equals(turnDir)&&(ConstantJBPM.SHOW_BACK.equals(modifyDto.getExt3())||ConstantJBPM.SHOW_ALL.equals(modifyDto.getExt3()))){
					this.completeJumpTask(taskId, turnDir, (String)variables.get(ConstantJBPM.JUMP_NAME_KEY), variables);
				}else if(ConstantJBPM.JUMP_OUT_NAME.equals(turnDir)&&(ConstantJBPM.SHOW_JUMP.equals(modifyDto.getExt3())||ConstantJBPM.SHOW_ALL.equals(modifyDto.getExt3()))){
					this.completeJumpTask(taskId, turnDir, (String)variables.get(ConstantJBPM.JUMP_NAME_KEY), variables);
				}else{
	...
	/*
	 * (non-Javadoc)
	 * @see com.jy.platform.jbpm4.service.JYTastService#insertBizOptionInf(com.jy.platform.jbpm4.dto.Jbpm4BizOptionInfoDTO)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.jy.platform.jbpm4.service.JYTastService#updateBizOptionInf(com.jy.platform.jbpm4.dto.Jbpm4BizOptionInfoDTO)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.jy.platform.jbpm4.service.JYTastService#deleteBizOptionInfByKey(com.jy.platform.jbpm4.dto.Jbpm4BizOptionInfoDTO, java.lang.String)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.jy.platform.jbpm4.service.JYTastService#getPartnerRuleInfo(java.lang.String, java.lang.String, java.util.Map)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.jy.platform.jbpm4.service.JYTastService#getPartnerRuleInfoAndPartnerId(java.lang.String, java.lang.String, java.util.Map)
	 */
	@Transactional(readOnly=true)
	public String getPartnerRuleInfoAndPartnerId(String taskId, String turnDir,Map<String, Object> proInsMap) throws Exception {
	    logger.debug("===1====taskId:{},turnDir：{},proInsMap:{}",taskId,turnDir,JSONObject.toJSONString(proInsMap));
		...
		logger.debug("===2====taskId:{},turnDir：{},proInsMap:{},reStr:{}",taskId,turnDir,JSONObject.toJSONString(proInsMap),reStr);
		return reStr;
	}
	...
	/*
	 * (non-Javadoc)
	 * @see com.jy.platform.jbpm4.service.JYTastService#getPartnerInfoByProDef(java.lang.String, java.lang.String, java.lang.String,Map<String,Object>)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.jy.platform.jbpm4.service.JYTastService#getProInsState(java.util.Map)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.jy.platform.jbpm4.service.JYTastService#getOperateTaskStateInfo(java.util.Map)
	 */
	...
	/*
	 * (non-Javadoc)
	 * @see com.jy.platform.jbpm4.service.JYTastService#exceptionStoProIns(java.lang.String, java.lang.String, java.lang.String, java.lang.String)
	 */
	@Transactional(rollbackFor=Exception.class)
    ...
    public List queryAllTask(Map<String, Object> param) throws Exception{
        ...
        if(param.get("extSort") != null && !"".equals(param.get("extSort"))) {
            dto.setExtSort((String)param.get("extSort"));
        }
	...
	/*
	 * (non-Javadoc)
	 * @see com.jy.platform.jbpm4.service.JYTastService#updateBizTaskTypeById(java.lang.String, java.lang.String)
	 */
	@Transactional(rollbackFor=Exception.class)
...
//				
//				}
				myJBPMTool.completeJumpTask(taskId, turnDir,targetTaskName, variables);
	}
	/**
	 * 获取历史任务名称
	...
	public List<String> getHistTaskName(String processInstanceId){
		return myJBPMTool.getHistTaskName(processInstanceId);
	}
}
