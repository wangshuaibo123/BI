...
public class ConstantJBPM {
	...
	public static final String PARTNER_TYPE_5_BEAN_ID = "com.jy.platform.jbpm4.jbpmPartner.JYSelectPartnerServiceImpl";
	//参与者 具体类型
	...
	//回退参数
	public static final String BACK_OUT_NAME ="回退";
	//回退参数
    public static final String BACK_STATE_TRUE ="true";
	//跳转参数
	public static final String JUMP_OUT_NAME ="跳转";
	//跳转参数
	public static final String JUMP_STATE_TRUE ="true";
	//跳转名称key
	public static final String JUMP_NAME_KEY ="jumpName";
	//跳转按钮
	public static final String SHOW_JUMP ="isJump";
	//跳转按钮
	public static final String SHOW_BACK ="isBack";
	//所有按钮
	public static final String SHOW_ALL ="isAll";
}
