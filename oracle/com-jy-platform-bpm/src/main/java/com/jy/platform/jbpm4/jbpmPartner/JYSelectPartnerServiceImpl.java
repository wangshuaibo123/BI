 ...
 */
@Service("com.jy.platform.jbpm4.jbpmPartner.JYSelectPartnerServiceImpl")
public class JYSelectPartnerServiceImpl implements JYSelectPartnerService ,Serializable{
    private static final Logger logger = LoggerFactory.getLogger(JYSelectPartnerServiceImpl.class);
	private static final long serialVersionUID = 1L;
	//获取 访问业务层的对象
	@Autowired
	@Qualifier("com.jy.platform.jbpm4.jbpmPartner.PartnerSysRule")
	...
	/*
	 * (non-Javadoc)
	 * @see com.jy.platform.jbpm4.service.JYSelectPartnerService#selectPartnerByOperator(java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.lang.String, java.util.Map)
	 */
	...
	public List<JYPartnerDTO> mutiSelectPartnerByOperator(String bizInfId,
	    ...
	    logger.debug("==1==mutiSelectPartnerByOperator===");
		List<JYPartnerDTO> partnerList = new ArrayList<JYPartnerDTO>();
		...
		logger.debug("==2==mutiSelectPartnerByOperator===");
		return partnerList;
	}
	...
	private List<JYPartnerDTO> dealLeaveUser(List<JYPartnerDTO> paraterList){
		...
		if("yes".equalsIgnoreCase(flowLeave)){
			if(paraters!=null){
				IJbpmService jbpmService =  (IJbpmService)context.getBean("com.jy.platform.jbpm4.service.impl.JbpmServiceImpl");
