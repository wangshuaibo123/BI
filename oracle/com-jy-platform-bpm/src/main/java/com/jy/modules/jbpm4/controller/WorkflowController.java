...
import com.jy.platform.restservice.exception.ValidationException;
...
public class WorkflowController extends BaseController{
	...
	public String updateJbpm4FormInfo(HttpServletRequest request,HttpServletResponse response, Jbpm4FormInfoDTO dto)throws Exception {
		...
		if(dto.getExt1()!=null&&!dto.getExt1().equals("")&&dto.getExt1().endsWith(",")){
			dto.setExt1(dto.getExt1().substring(0, dto.getExt1().length()-1));
		}
		if(dto.getExt2()!=null&&!dto.getExt2().equals("")&&dto.getExt2().endsWith(",")){
			dto.setExt2(dto.getExt2().substring(0, dto.getExt2().length()-1));
		}
		//dto.setLastUpdBy("1");
		paramMap.put("dto", dto);
		try {
