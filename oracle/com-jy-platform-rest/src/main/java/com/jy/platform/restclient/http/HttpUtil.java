...
public class HttpUtil {
	...
	public  <T,D> ResponseMsg<T> execute(String appId, String url, String methodType, TypeReference<ResponseMsg<T>> typeReference,D data)throws RestException{
	...
	private  <T> ResponseMsg<T>  processStatus(int statusCode,ResponseMsg<T> t)throws RestException{
		if (statusCode==200) {
	...
	public <T> String execute(String url, String methodType, T data)throws RestException{
		logger.debug("request: {} @ {} @ {}",url,methodType,data);
