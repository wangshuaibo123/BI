...
public class AuthConfig {
	...
	public static void parseAutoConfigXml() throws Exception{
		...
		try{
		    ...
		    ClassPathResource serviceElement = new ClassPathResource("auth-service.xml");
            SAXReader list = new SAXReader();
            d = list.read(serviceElement.getInputStream());
		}
	...
	public static String  getAppId(String authorization){
		...
		if(authorization!=null&&!authorization.equals("")){
			  String idPwd = Base64.base64Decode(authorization);
			  appId=idPwd.split(":")[0];
		}
