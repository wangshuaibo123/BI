	...
	public int doEndTag () throws JspException{
		...
		try{
			...
			if(StringUtils.isEmpty(userId)){
				com.jy.platform.api.org.SessionAPI sessionAPI = (com.jy.platform.api.org.SessionAPI)context.getBean("sessionAPI");
				com.jy.platform.api.org.UserInfo userInfo = sessionAPI.getCurrentUserInfo(); 
				this.setUserId(userInfo.getUserId().toString());
			}
			
			com.jy.platform.api.sysauth.SysRoleAPI roleAPI = (com.jy.platform.api.sysauth.SysRoleAPI)context.getBean("sysRoleAPI");
