...
import com.fintech.modules.bpmreport.service.RoleBPMReportService;
...
public class RoleBPMReportController extends BaseController {
	...
	@ResponseBody
	public List<DataBean> getOverStockMostData(HttpServletRequest request, HttpServletResponse response) throws Exception {
		// 当前登录系统的用户id
