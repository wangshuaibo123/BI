...
import com.fintech.modules.bpmreport.dao.DeptBPMReportDao;
 ...
 * @date 2016-2-17
 */
@Service("deptBPMReportService")
public class DeptBPMReportService implements Serializable {

	private static final long serialVersionUID = 1L;
	
	@Autowired
	private DeptBPMReportDao deptBPMReportDao;
	@Autowired
	...
	public List<DataBean> getOverStockMostData(UserInfo userInfo) {
		...
		List<DataBean> list=deptBPMReportDao.getOverStockMostDataList(map);
		return list;
	}
	...
	public List<DataBean> getProcessedMostData(UserInfo userInfo) {
		...
		map.put("isAdmin", isAdmin);
		map.put("orgId", userInfo.getOrgId());
		List<DataBean> list=deptBPMReportDao.getProcessedMostData(map);
		return list;
	}
	/**
	 * 获取发起最多TOP10的数据
	...
	public List<DataBean> getStartUpMostData(UserInfo userInfo) {
		...
		map.put("isAdmin", isAdmin);
		map.put("orgId", userInfo.getOrgId());
		List<DataBean> list=deptBPMReportDao.getStartUpMostData(map);
		return list;
	}
	/**
	 * 平均速率最高TOP10
	...
	public List<DataBean> getAvgEfficientHighestData(UserInfo userInfo) {
		...
		map.put("isAdmin", isAdmin);
		map.put("orgId", userInfo.getOrgId());
		List<DataBean> list=deptBPMReportDao.getAvgEfficientHighestData(map);
	...
	public List<DataBean> getAvgEfficientLowestData(UserInfo userInfo) {
		...
		map.put("isAdmin", isAdmin);
		map.put("orgId", userInfo.getOrgId());
		List<DataBean> list=deptBPMReportDao.getAvgEfficientLowestData(map);
		return dealData(list);
	}
	/**
	 * 获取 委托 最多 TOP10 数据
	...
	public List<DataBean> getEntrustMostData(UserInfo userInfo) {
		...
		map.put("isAdmin", isAdmin);
		map.put("orgId", userInfo.getOrgId());
		List<DataBean> list=deptBPMReportDao.getEntrustMostData(map);
		return list;
	}
	/**
	 * 获取乐于助人最多TOP10 数据
	...
	public List<DataBean> getSupportMostData(UserInfo userInfo) {
		...
		map.put("isAdmin", isAdmin);
		map.put("orgId", userInfo.getOrgId());
		List<DataBean> list=deptBPMReportDao.getSupportMostData(map);
		return list;
	}
	...
	public List<DataBean> getEntrustStateData(UserInfo userInfo) {
		...
		map.put("isAdmin", isAdmin);
		map.put("orgId", userInfo.getOrgId());
		List<DataBean> list=deptBPMReportDao.getEntrustStateData(map);
		return list;
	}
