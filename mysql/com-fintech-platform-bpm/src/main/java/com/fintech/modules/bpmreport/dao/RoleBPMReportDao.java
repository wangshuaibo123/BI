 ...
 */
@MyBatisRepository
public interface RoleBPMReportDao extends Serializable {
	 ...
	 * @return
	 */
	public Map<String,Object> getSysOrgChildList(Map<String, Object> map) ;
	public List<Map<String,String>> getOrgChild(Map<String, String> param);
