package com.fintech.platform.jbpm4.drawJbpmPng;
...
public class Test {
	public static void main(String[] args) {
		...
		try {
	        ...
	        IModifyProInfoService service = (IModifyProInfoService) context.getBean("com.fintech.platform.jbpm4.service.impl.ModifyProInfoServiceImpl");
