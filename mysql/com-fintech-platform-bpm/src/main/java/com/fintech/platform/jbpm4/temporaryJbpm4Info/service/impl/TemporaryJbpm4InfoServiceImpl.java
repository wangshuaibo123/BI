package com.fintech.platform.jbpm4.temporaryJbpm4Info.service.impl;
 ...
 */
@Service("com.fintech.platform.jbpm4.temporaryJbpm4Info.service.impl.TemporaryJbpm4InfoServiceImpl")
public class TemporaryJbpm4InfoServiceImpl implements ITemporaryJbpm4InfoService,Serializable {
	...
	public int updateProPngOfTempJbpm4Info(JbpmBlobDTO pngDTO)
		 ...
		 * */
		/*Map<String, Object> paramMap =  new HashMap<String,Object>();
		paramMap.put("id", pngDTO.getId());
		TemporaryJbpm4InfoDTO tempDTO = mapper.queryOneTemporaryJbpm4_info(paramMap);
		
		paramMap.put("proVer", tempDTO.getProcVersion());
		paramMap.put("proName", tempDTO.getProcName());
		
		mapper.updateProPngOfTempJbpm4Info1(paramMap);*/
