...
public class FTPUtils {
	 ...
	 * @param remoteDir 
	 */  
	public FTPUtils(String hostname, int port, String username, String password, String remoteDir) {  
	...
	public static void main(String []a) throws Exception{
		FTPUtils ftp=new FTPUtils("172.18.100.157", 21, "jyftp", "gy2Z(eNLzMAJ", null);
		ftp.login();
		ftp.upload("H:\\DbVisualizer.rar", "DbVisualizer.rar");
		ftp.closeServer();
	}
}
