...
public class DateUtil {
	...
	private static SimpleDateFormat sdfFormat = new SimpleDateFormat("yyyyMMddHHmmss");
	 ...
	 * @return
	 */
	public static long daysOfTwo(Date date1, Date date2) {
		long quot = 0;
		try {
			if(date1.after(date2)){
				quot = date1.getTime() - date2.getTime();
