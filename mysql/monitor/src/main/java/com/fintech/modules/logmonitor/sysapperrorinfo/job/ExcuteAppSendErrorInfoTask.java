...
import com.fintech.modules.logmonitor.sysapperrorinfo.dto.SysAppErrorLevelDetailDTO;
...
import com.fintech.modules.logmonitor.sysappmanagecontactway.service.SysAppManageContactWayService;
import com.fintech.modules.platform.sysconfig.service.SysConfigService;
import com.fintech.modules.platform.sysdict.service.SysDictDetailService;
import com.fintech.platform.tools.mail.MessageUtil;

@Component("com.fintech.modules.logmonitor.sysapperrorinfo.job.ExcuteAppSendErrorInfoTask")
public class ExcuteAppSendErrorInfoTask implements Serializable, Job{
	...
	public void execute(JobExecutionContext context) throws JobExecutionException {
		...
		try {
			...
			sysConfigService = (SysConfigService) appCtx.getBean("com.fintech.modules.platform.sysconfig.service.SysConfigService");
			...
			logger.error("---------------ExcuteAppSendErrorInfoTask--error----------", ex);
		}
		finally{
	...
	private void sendMail(
		...
		for(String key: manageError.keySet()){
			...
			if(flag){
				String monitorWebAddr = sysConfigService.queryValueByCode("MONITOR_WEB_ADDR");
				if(StringUtils.isBlank(monitorWebAddr)) {
					monitorWebAddr = "";
				}

				emailContent.append(" 请登录<a href='").append(monitorWebAddr).append("'>日志系统</a>查看详细信息。 ");
