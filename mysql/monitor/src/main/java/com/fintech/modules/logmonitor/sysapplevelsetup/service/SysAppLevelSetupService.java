package com.fintech.modules.logmonitor.sysapplevelsetup.service;
...
import com.fintech.modules.logmonitor.sysapplevelsetup.dao.SysAppLevelSetupDao;
 ...
 * @author:  lei
 */
@Service("com.fintech.modules.logmonitor.sysapplevelsetup.service.SysAppLevelSetupService")
public class SysAppLevelSetupService implements Serializable {
	...
	public int searchMaxRateOfUnit(String rateUnit) throws Exception{
		...
		Integer maxRate = dao.searchMaxRateOfUnit(searchParams);
