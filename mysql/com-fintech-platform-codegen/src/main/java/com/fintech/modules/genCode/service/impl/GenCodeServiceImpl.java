package com.fintech.modules.genCode.service.impl;
...
import com.fintech.modules.genCode.repository.GenCodeMapper;
 ...
 */
@Service("com.fintech.modules.genCode.service.impl.GenCodeServiceImpl")
public class GenCodeServiceImpl implements IGenCodeService, Serializable {
    ...
    private static final String BASEDTO = "import com.fintech.platform.core.common.BaseDTO;";
...
/*
 * (non-Javadoc)
 * @see com.pt.demo.dao.service.IGenCodeService#proActionCode(java.util.Map)
 */
    ...
    private void writeDTOToFile(ProductCodeDTO proCodeDTO, List columnsList) {
        ...
        try {
            ...
            for (int i = 0; i < columnsList.size(); i++) {
                ...
                content.append("\t}\n\n");
                content.append("\t/**\n");
                content.append((new StringBuilder("\t *方法: 设置")).append(StringUtilTools.convertName(field, true))
                        .append("\n").toString());
    ...
    public ProductCodeDTO makeupProductDtoParams(ProductCodeDTO dto) {
        ...
        // IService包名
        String iServicePackageName = packageNamePrefix + ISERVICE_PACKAGE;// com.pt.demo.dao.service
        ...
        // ServiceImpl包名
        String serviceImplPackageName = packageNamePrefix + SERVICE_IMPL_PACKAGE;// com.pt.demo.dao.service.impl
        ...
        // Mapper包名
        String mapperPackageName = packageNamePrefix + MAPPER_PACKAGE;// com.pt.demo.dao.repository
...
/*
 * (non-Javadoc)
 * @see com.pt.demo.dao.service.IGenCodeService#proJSPCode(java.util.Map)
 */
