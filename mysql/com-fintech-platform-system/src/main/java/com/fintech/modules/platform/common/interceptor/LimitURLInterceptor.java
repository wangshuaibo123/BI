 ...
 * <bean id="loanAuditAPP" class="com.fintech.modules.platform.common.interceptor.LimitURLInterceptor" scope="prototype">
            </bean>
...
public class LimitURLInterceptor implements HandlerInterceptor {
	...
	//定义限流的业务模块名称 如：com.fintech.modules.befloan.creditaudit.creditmarry.controller.AuditMatchController.toMatch(.*)
	//定义模块 并发访问上线
	...
	private void addOneForList(HttpServletRequest request,HttpServletResponse response, Object handler) throws Exception {
		...
		com.fintech.platform.api.sysdict.SysDictAPI dictAPI = (com.fintech.platform.api.sysdict.SysDictAPI) context.getBean(com.fintech.platform.api.sysdict.SysDictAPI.class);
		//设置限流的模块
