package com.fintech.modules.platform.sysbizlog.dto;
...
public class SysBizLogDTO extends BaseDTO{
	...
	public enum LogType {
	       interfacelog("interfacelog","interfacelog") , businesslog ("businesslog","performancelog") , performancelog("performancelog","performancelog") ;
	...
	public java.lang.String getLogTypeCN(){
		this.logOperateCN = "";
		if(this.getLogOperate().equals(SysBizLogDTO.OperateType.login.toString())){
			logOperateCN = SysBizLogDTO.OperateType.login.toStringCN();
		}else if (this.getLogOperate().equals(SysBizLogDTO.OperateType.insert.toString())) {
			logOperateCN = SysBizLogDTO.OperateType.insert.toStringCN();
		}else if (this.getLogOperate().equals(SysBizLogDTO.OperateType.update.toString())) {
			logOperateCN = SysBizLogDTO.OperateType.update.toStringCN();
		}else if (this.getLogOperate().equals(SysBizLogDTO.OperateType.view.toString())) {
			logOperateCN = SysBizLogDTO.OperateType.view.toStringCN();
		}else if (this.getLogOperate().equals(SysBizLogDTO.OperateType.delete.toString())) {
