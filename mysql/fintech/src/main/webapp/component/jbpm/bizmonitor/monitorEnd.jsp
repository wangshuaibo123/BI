	...
	function initFn(){
		...
		//定义 form表单查询 信息
		 var formStructure={
	        ...
	        ,{display : '申请产品', code : 'appProductType', width : 200,  type:'select', value:<pc:productTag type="json"></pc:productTag>}
	        ,{display : '所属门店', code : 'intoSource', width : 190,  type:'tree',treeWidth:200,treeHeight:300,value:'${basePath}sysOrg/queryTreeSysOrg?openParentId=${curUser.orgId}'}
		...
		var tableStructure = {
				...
				{display : '发起时间', code : 'CREATE_TIME', width : 120, align : 'center', type:'text', isOrder : true},
				{display : '办结时间', code : 'PRO_END_TIME', width : 120, align : 'center', type:'text', isOrder : true},
