...
function toAddData(){
	var dialogStruct={
		'display':contextRootPath+'/sysChanageDetail/prepareExecute/toAdd',
		'width':800,
		'height':500,
		'title':'新增',
		'isIframe':'false',
...
function doAddFrom(){
	...
	var url=contextRootPath+'/sysChanageDetail/insertSysChanageDetail';
	//通过ajax保存
	jyAjax(
		url,
		params,
...
function toUpdateData(){
	...
	var dialogStruct={
			'display':contextRootPath+'/sysChanageDetail/prepareExecute/toUpdate?id='+v_ids,
			'width':800,
			'height':500,
			'isIframe':'false',
			'title':'修改',
...
function doUpdateFrom(){
	...
	var url=contextRootPath+'/sysChanageDetail/updateSysChanageDetail';
	//通过ajax保存
	jyAjax(
		url,
		params,
...
function deleteData(){
	...
	jyDialog({"type":"question"}).confirm("您确认要删除选择的数据吗？",function(){
		var url=contextRootPath+"/sysChanageDetail/deleteSysChanageDetail";
...
function viewData(vId){
	var dialogStruct={
		'display':contextRootPath+'/sysChanageDetail/prepareExecute/toView?id='+vId,
		'width':800,
		'height':500,
		'title':'查看明细',
		'isIframe':'false',
